...
```bash
# Campaign index ingestion - campaign level (hourly at :20)
# Captures campaign-level metadata and Facebook campaign IDs from Facebook campaigns API
...
# Campaign index ingestion - adset level (hourly at :21)
# IMPORTANT: Captures Facebook campaign IDs from Facebook adset data (adsets contain campaign_id field)
